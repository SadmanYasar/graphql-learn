# IMPORTANT
If apollo studio is failing to fetch, make sure the [router](https://www.apollographql.com/tutorials/voyage-part1/08-router-configuration-and-uplink) is running and the APOLLO_KEY and APOLLO_GRAPH_REF environment variables are set.
